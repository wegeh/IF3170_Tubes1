...
class SimulatedAnnealingPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        label = ttk.Label(scrollable_frame, text="Simulated Annealing Algorithm", font=("Helvetica", 16))
        label.pack(pady=20)
        ...
        start_button = ttk.Button(scrollable_frame, text="Start", command=self.start_simulated_annealing)
    ...
    def start_simulated_annealing(self):
        ...
        try:
            ...
            return
        self.result_text.delete(1.0, tk.END)
        self.result_text.insert(tk.END, "Running Simulated Annealing...\n")
