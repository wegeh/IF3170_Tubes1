...
class SteepestAscentPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        label = ttk.Label(scrollable_frame, text="Steepest Ascent Algorithm", font=("Helvetica", 16))
        label.pack(pady=20)

        start_button = ttk.Button(scrollable_frame, text="Start", command=self.start_steepest_ascent)
    ...
    def start_steepest_ascent(self):
        self.result_text.delete(1.0, tk.END)
        self.result_text.insert(tk.END, "Running Steepest Ascent Algorithm...\n")
